...
from model.modrelu import modrelu
...
def _eunn_param(hidden_size, capacity=2, fft=False, comp=True):
    ...
    if fft:
        ...
        params_theta_0 = vs.get_variable(
            "theta_0", [capacity_a, hidden_size_a], initializer=theta_phi_initializer)
        ...
        params_theta_1 = vs.get_variable(
            "theta_1", [capacity_b, hidden_size_b], initializer=theta_phi_initializer)
        ...
        if comp:
            params_phi_0 = vs.get_variable(
                "phi_0", [capacity_a, hidden_size_a], initializer=theta_phi_initializer)
            ...
            params_phi_1 = vs.get_variable(
                "phi_1", [capacity_b, hidden_size_b], initializer=theta_phi_initializer)
...
def _eunn_loop(state, capacity, diag_vec_list, off_vec_list, diag, fft):
    ...
    def layer_tunable(x, i):
        ...
        if size % 2 == 0:
            ...
            func_s = odd_s
            dfunc_s = even_s
        off = control_flow_ops.cond(tf.equal(i % 2, 0), lambda: even_input(
